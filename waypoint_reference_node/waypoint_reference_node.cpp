...
int main(int argc, char **argv){
    ...
    rosunit_restricted_norm_settings->addCallbackMsgReceiver((MsgReceiver*)waypoint_generator->getPorts()[(int)RestrictedNormWaypointRefGenerator::ports_id::IP_1_SETTINGS]);
